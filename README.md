...
| :--- | :--- | :--- | :--- |
| ** Online Judge Platform**<br/>*AlgoUniversity SWE Co-op* | •  Dockerized code execution sandboxing<br/>•  Gemini AI integration for code analysis<br/>•  Real-time submission tracking | `Django` `SQLite` `Docker` `Gemini AI` | <!-- Add link if available --> |
